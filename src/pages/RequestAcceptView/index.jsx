      ...
      <div className="bg-white-A700 flex flex-col items-center justify-start mx-auto w-full">
        <div className="flex flex-col justify-start w-full">
          ...
          <div className="flex md:flex-col flex-row font-mulish gap-[30px] items-start justify-start max-w-[1170px] mt-10 mx-auto md:px-5 w-full">
            ...
            <div className="bg-white-A700 flex md:flex-1 flex-col items-start justify-start mb-[342px] py-3 rounded shadow-bs8 w-[32%] md:w-full">
              <Text
              ...
              <Line className="bg-gray-100 h-px mt-[17px] w-full" />
              <div className="flex flex-col items-start justify-start mb-[37px] md:ml-[0] ml-[30px] mt-7 w-[84%] md:w-full">
                ...
                <Text
                  className="capitalize mt-5 text-[15px] text-blue_gray-900"
                  size="txtMulishBold15Bluegray900"
                >
                  Location: Quảng Nam, Việt Nam
                </Text>
                <Button
                  className="common-pointer capitalize cursor-pointer font-bold h-[52px] leading-[normal] mt-[33px] rounded-[3px] text-center text-xl w-[310px]"
...
export default RequestAcceptViewPage;
