            ...
            <div className="flex flex-col gap-[53px] items-center justify-start w-[76%] md:w-full">
              <div className="flex flex-col items-center justify-start w-full">
                <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
                  ...
                  <Button
                    className="common-pointer border border-black-900 border-solid cursor-pointer font-notosanshebrewdroid leading-[normal] min-w-[299px] rounded-[15px] md:text-3xl sm:text-[28px] text-[32px] text-center"
                    onClick={() => navigate("/rentexchange")}
...
export default RentExchangeOnePage;
