  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-nicomoji items-center justify-start mx-auto w-full">
        ...
        <div className="font-inter sm:h-[1301px] md:h-[1308px] h-[1718px] md:px-5 relative w-full">
            ...
            <div className="flex flex-col gap-[53px] items-center justify-start w-[76%] md:w-full">
              <div className="flex flex-col items-center justify-start w-full">
                <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
                  <Text
                    className="bg-green-200 border border-black-900 border-solid h-[53px] justify-center pb-[5px] pt-[9px] sm:px-5 px-[34px] rounded-[15px] md:text-3xl sm:text-[28px] text-[32px] text-black-900 w-[299px]"
                    size="txtNotoTraditionalNushuRegular32Black900"
                  >
                    Rental History{" "}
                  </Text>
                  <Text
...
export default RentExchangeThreePage;
