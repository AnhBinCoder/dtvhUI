...
const WaitlistExchangeRequestsPage = () => {
    ...
    <>
      <div className="bg-white-A700 font-sfprodisplay h-[2187px] mx-auto relative w-full">
        ...
        <div className="absolute bg-blue_gray-900_87 bottom-[0] flex flex-col inset-x-[0] items-end justify-start mx-auto p-[462px] md:px-10 sm:px-5 w-full">
          <div className="bg-red-700 flex flex-col gap-[9px] items-center justify-center mb-[844px] mt-[313px] p-[34px] md:px-5 rounded-[10px] w-[83%] md:w-full">
            <div className="flex flex-col font-roboto gap-[30px] items-center justify-start mt-[85px] w-auto">
              ...
              <div className="flex flex-col gap-[15px] items-center justify-start w-auto">
                ...
                >
                  Your exchange has refused. For more details, check your
                  rent/exchange history.
                </Text>
              </div>
            </div>
            <Button
              className="common-pointer cursor-pointer font-nototraditionalnushu leading-[normal] mb-4 min-w-[203px] rounded-[10px] md:text-3xl sm:text-[28px] text-[32px] text-center"
...
export default WaitlistExchangeRequestsPage;
