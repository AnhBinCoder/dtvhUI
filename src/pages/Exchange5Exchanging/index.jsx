      ...
      <div className="bg-white-A700 flex flex-col font-nicomoji items-center justify-start mx-auto w-full">
        ...
        <div className="flex flex-col font-volkhov items-center justify-end mt-[9px] p-[41px] md:px-10 sm:px-5 w-full">
          <div className="flex flex-col justify-start max-w-[1219px] mt-[11px] mx-auto w-full">
            <Text
              className="md:ml-[0] ml-[414px] text-4xl sm:text-[32px] md:text-[34px] text-blue_gray-900 text-center"
            ...
            <div
              className="common-pointer bg-yellow-600_01 flex md:flex-col flex-row font-lato gap-3 items-start justify-center md:ml-[0] ml-[505px] mr-[472px] mt-[37px] pl-[15px] pt-[15px] rounded-[12px] shadow-bs9 w-1/5 md:w-full"
              onClick={() => navigate("/exchange6confirm")}
            >
              <Text
                className="md:ml-[0] ml-[58px] text-[22px] text-black-900 text-center sm:text-lg md:text-xl"
                size="txtLatoExtraBold22"
              >
                Exchange
              </Text>
              <Img
                className="h-[34px] md:mt-0 mt-[3px]"
...
export default Exchange5ExchangingPage;
