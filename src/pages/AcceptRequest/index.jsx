...
const AcceptRequestPage = () => {
  ...
  return (
    <>
      <div className="bg-white-A700 font-roboto h-[2656px] mx-auto relative w-full">
            ...
            <div className="flex md:flex-col flex-row font-mulish gap-[30px] items-start justify-start max-w-[1170px] mt-10 mx-auto md:px-5 w-full">
              ...
              <div className="bg-white-A700 flex md:flex-1 flex-col items-start justify-start mb-[303px] py-[11px] rounded shadow-bs8 w-[32%] md:w-full">
                ...
                <div className="flex flex-col items-start justify-start mb-[23px] md:ml-[0] ml-[30px] mt-[27px] w-[84%] md:w-full">
                  ...
                  <Button
                    className="capitalize cursor-pointer font-bold h-[50px] leading-[normal] mt-6 rounded-[3px] text-[15px] text-center w-[310px]"
                    color="teal_200"
                    size="xl"
                    variant="fill"
                  >
                  ...
                  <Button
                    className="capitalize cursor-pointer font-bold h-[50px] mt-[27px] rounded-[3px] text-[15px] text-center w-[310px]"
                    color="gray_600"
                    size="xl"
                    variant="outline"
                  >
                ...
                >
                  <span className="text-blue_gray-700 font-mulish text-left font-normal">
                    <>
                      ...
                      heart of the Hoi An Ancient Town in Vietnam. Thebsite
                      offers an immersive experience of traditional art, tea
                      culture, and local cuisine. The center features a range of
                      artwork from different artists, tea ceremonies, cooking
                      classes, and guided walking tours. Visitors can also enjoy
                      a cup of rare Vietnamese teas while taking in the
                  ...
                  <span className="text-blue_gray-700 font-mulish text-left font-normal">
                    <>
                      ...
                      Chaozhou Chinese Congregation, Hoian Central Hotel
                      features accommodation with free bikes, free private
                      parking, an outdoor swimming pool and a garden. This
                      3-star hotel offers an ATM and a concierge service. The
                      accommodation provides a 24-hour front desk, airport
                      transfers, a shared lounge and free WiFi. The hotel will
                      provide guests with air-conditioned rooms offering a desk,
                      a kettle, a minibar, a safety deposit box, a flat-screen
                      TV and a private bathroom with a bidet. All rooms have a
                      wardrobe. Hoian Central Hotel offers a terrace. Hoi An
                      Historic Museum is less than 1 km from the accommodation,
                      while Japanese Covered Bridge is a 11-minute walk from the
                      property. The nearest airport is Da Nang International
                      Airport, 30 km from Hoian Central Hotel.
                      <br />
                      <br />
        ...
        <div className="absolute bg-blue_gray-900_87 flex flex-col h-max inset-[0] items-end justify-center m-auto p-[465px] md:px-10 sm:px-5 w-full">
          <div
            className="bg-cover bg-no-repeat bg-white-A700 flex flex-col h-[683px] items-center justify-start mb-[568px] mt-[471px] p-[52px] md:px-5 w-[88%] md:w-full"
            style={{
            ...
            <div className="flex flex-col gap-[51px] items-center justify-start mb-[45px] mt-[119px] w-[96%] md:w-full">
              ...
              <div className="flex flex-col gap-9 items-center justify-start w-[57%] md:w-full">
                <Button
                  ...
                  onClick={() => navigate("/requestacceptview")}
                  color="yellow_600_01"
                  size="md"
                  variant="fill"
                >
