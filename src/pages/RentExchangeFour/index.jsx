    ...
    <>
      <div className="bg-white-A700 font-nicomoji h-[2187px] mx-auto relative w-full">
        <div className="absolute flex flex-col h-full inset-[0] items-center justify-center m-auto w-full">
          ...
          <div className="font-inter md:h-[1222px] sm:h-[1301px] h-[1718px] md:px-5 relative w-full">
        ...
        <div className="absolute bg-black-900_87 bottom-[0] flex flex-col font-roboto inset-x-[0] items-end justify-end mx-auto p-[445px] md:px-10 sm:px-5 w-full">
          <div className="flex flex-col items-center justify-start mb-[447px] mt-[338px] w-[78%] md:w-full">
            <div className="bg-teal-A400 flex flex-col gap-[15px] items-center justify-center p-[34px] sm:px-5 rounded-[10px] w-full">
              <div className="flex flex-col gap-[30px] items-center justify-start mt-[85px] w-auto">
                <Img
                ...
                <div className="flex flex-col gap-[15px] items-center justify-start w-auto">
                  ...
                  >
                    <>
                      {" "}
                      Your exchange has canceled. For more details, check your
                      rent/exchange history. <br /> Because the exchange owner
                      has not yet accepted your request, the cancellation
                      operation was successful.
                      <br /> Money will be returned to your wallet within 7
                      days, please check your wallet. <br /> If you have any
                      questions, please contact the customer support hotline
                    </>
                  </Text>
                </div>
              </div>
              <div
                className="bg-cover bg-no-repeat flex flex-col font-nototraditionalnushu h-[66px] items-start justify-start mb-[19px] p-[13px]"
                style={{ backgroundImage: "url('images/img_group310.svg')" }}
              >
                <Text
                  className="ml-10 md:ml-[0] md:text-3xl sm:text-[28px] text-[32px] text-gray-900_02"
                  size="txtNotoTraditionalNushuRegular32Gray90002"
                >
                  BACK
                </Text>
              </div>
...
export default RentExchangeFourPage;
