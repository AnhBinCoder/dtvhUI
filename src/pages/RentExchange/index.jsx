  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-nicomoji items-center justify-start mx-auto w-full">
        ...
        <div className="font-sfprodisplay sm:h-[1301px] h-[1718px] md:h-[1746px] md:px-5 relative w-full">
          ...
          <div className="absolute flex flex-col font-mulish gap-10 items-center justify-start right-[5%] top-[12%] w-[71%]">
            <div className="flex flex-col gap-[53px] items-center justify-start w-[76%] md:w-full">
              <div className="flex flex-col items-center justify-start w-full">
                <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
                  <Button
                    className="common-pointer border border-black-900 border-solid cursor-pointer font-nototraditionalnushu leading-[normal] min-w-[299px] rounded-[15px] md:text-3xl sm:text-[28px] text-[32px] text-center"
                  ...
                  <Text
                    className="bg-deep_orange-200 border border-black-900 border-solid h-[53px] justify-center pb-0.5 pt-1.5 px-[17px] rounded-[15px] md:text-3xl sm:text-[28px] text-[32px] text-red-600 w-[299px]"
                    size="txtNotoSansHebrewDroidRegular32Red600"
                  >
                    Exchange History
                  </Text>
                </div>
                  ...
                  <div className="flex md:flex-col flex-row gap-[23px] items-start justify-between w-[98%] md:w-full">
                    ...
                    <div className="flex flex-col items-center justify-start md:mt-0 mt-[23px]">
                      ...
                      <div className="flex sm:flex-col flex-row sm:gap-10 items-start justify-between mt-1.5 w-full">
                        ...
                        <Button
                          className="common-pointer cursor-pointer font-medium font-rubik min-w-[106px] sm:mt-0 mt-2.5 text-base text-center"
                          onClick={() => navigate("/cancelexchange")}
                          shape="round"
                          color="gray_600_03"
                          size="xs"
                          variant="fill"
...
export default RentExchangePage;
