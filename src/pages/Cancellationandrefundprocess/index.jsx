...
const CancellationandrefundprocessPage = () => {
  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-nicomoji items-center justify-start mx-auto w-full">
        ...
        <div className="font-sfprodisplay sm:h-[1301px] md:h-[1485px] h-[1718px] md:px-5 relative w-full">
          ...
          <div className="absolute flex flex-col font-sourcesanspro gap-[11px] items-start justify-start right-[6%] top-[6%] w-[66%]">
            ...
            <div
              ...
              onClick={() => navigate("/cancellationandrefundprocessone")}
            ></div>
          </div>
        </div>
      </div>
...
export default CancellationandrefundprocessPage;
